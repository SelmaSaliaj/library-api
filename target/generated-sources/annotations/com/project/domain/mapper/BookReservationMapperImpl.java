...
public class BookReservationMapperImpl implements BookReservationMapper {
    ...
    @Override
    public BookReservationEntity toBookReservationEntity(BookReservationDTO dto, BookReservationEntity reservation) {
        if ( dto == null ) {
            return reservation;
        }

        reservation.setReservation( toReservationEntity( dto.getReservation() ) );
        reservation.setBook( toPhysicalCopyEntity( dto.getBook() ) );
        reservation.setId( dto.getId() );
        reservation.setCreatedDate( dto.getCreatedDate() );
        reservation.setLastModified( dto.getLastModified() );
        reservation.setReturnedDate( dto.getReturnedDate() );
        reservation.setDeleted( dto.isDeleted() );
        reservation.setChanged( dto.getChanged() );
